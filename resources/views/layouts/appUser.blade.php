    ...
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="{{ route ('user.dashboard') }}">Status Approval</a></li>
          <li><a class="dropdown-item" href="{{ route ('user.show') }}">Event Pictures</a></li>
        </ul>
        {{-- <a
          href="#"
          class="list-group-item list-group-item-action py-2 ripple dropdown-toggle"
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="{{ route ('user.viewReport') }}">Report Event</a></li>
