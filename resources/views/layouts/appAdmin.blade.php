  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse" style="background: #f9c046">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        >
          <i class="fas fa-solid fa-check-square fa-fw me-3"></i><span>PaperWorks</span>
        </a>
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="{{ route ('event.create') }}">Create Event</a></li>
          <li><a class="dropdown-item" href="{{ route ('event.index') }}">Manage Event</a></li>
          <li><a class="dropdown-item" href="{{ route ('event.show') }}">Event Pictures</a></li>
        </ul>
        {{-- <a
          href="#"
          class="list-group-item list-group-item-action py-2 ripple dropdown-toggle"
        ...
        <a
          ...
          style="background: #fad074"
        >
          <i class="fas fa-solid fa-address-book fa-fw me-3"></i><span>Report</span>
        </a>
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="{{ route ('admin.viewReport') }}">Report Event</a></li>
          {{-- <li><a class="dropdown-item" href="{{ url('userManual') }}">Dropdown Item 2</a></li>
          <li><a class="dropdown-item" href="{{ url('userManual') }}">Dropdown Item 3</a></li> --}}
        </ul>
      </div>
    </div>
  </nav>
